...
unit_tests = [
    ...
    UnitTest("Meshes - opt"                            ,"Meshes/opt_meshes.jl"; tier = :opt, subsystem = :meshes),
    ...
    UnitTest("Spectral elem - opt"                     ,"Operators/spectralelement/opt_spectralelement.jl"; tier = :opt, subsystem = :operators),
