...
@testset "kernel renaming" begin
    ...
    old_flag = ext.NAME_KERNELS_FROM_STACK_TRACE[]
    ext.NAME_KERNELS_FROM_STACK_TRACE[] = true
    # Restore global setting on completion or failure to prevent state leakage
    # (e.g. stacktrace inspection overhead and kernel_names logging) into subsequent tests.
    try
        ...
        ext.NAME_KERNELS_FROM_STACK_TRACE[] = old_flag
    end
end
