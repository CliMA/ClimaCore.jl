...
@testset "HDF5 restart test for 3d hybrid cubed sphere" begin
    ...
    InputOutput.write!("hybrid3dcubedsphere.hdf5", "Y" => Y) # write field vector from hdf5 file
    restart_Y = InputOutput.read("hybrid3dcubedsphere.hdf5", "Y") # read fieldvector from hdf5 file
