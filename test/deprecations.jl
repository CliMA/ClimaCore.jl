...
@testset "Deprecations" begin
    ...
    # For when Nh is in the type-domain
    # S = Float64
    # @test_deprecated DataLayouts.IJHF{S, 3}(zeros(3, 3, 1, 10))
    # @test_deprecated DataLayouts.IJHF{S, 3}(typeof(zeros(3, 3, 1, 10)), 10)
    # @test_deprecated DataLayouts.IHF{S, 3}(zeros(3, 1, 10))
    # @test_deprecated DataLayouts.VIJHF{S, 10, 4}(zeros(10, 4, 4, 1, 20))
    # @test_deprecated DataLayouts.VIHF{S, 10, 4}(zeros(10, 4, 1, 20))
end
