...
first-order analytic solution of [Klemp03a](@cite). The script sets a 250 m
mountain; the figure above is the linear-regime 25 m case, which is configured
in ClimaAtmos. The tendency is the staggered nonhydrostatic model
