...
const Ω = FT(7.29212e-5) # Earth's rotation rate
# const f = ?            # Coriolis frequency (not required for spherical space)
...
function center_initial_condition(local_geometry, ᶜ𝔼_name, is_balanced_flow)
