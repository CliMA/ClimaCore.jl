...
function rhs!(dY, Y, parameters, t)
    ...
    χuₕ = @. duₕ = hwgrad(hdiv(cuₕ)) - Geometry.project(Geometry.Covariant12Axis(), hwcurl(Geometry.project(Geometry.Covariant3Axis(), hcurl(Y.uₕ))))
