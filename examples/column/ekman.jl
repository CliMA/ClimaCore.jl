...
function tendency!(dY, Y, _, t)
    ...
    # u-momentum
    bcs_bottom = Operators.SetValue(Geometry.Cartesian3Vector(Cd * u_wind * u_1))  # Eq. 4.16
    ...
    # v-momentum
    bcs_bottom = Operators.SetValue(Geometry.Cartesian3Vector(Cd * u_wind * v_1))  # Eq. 4.17
