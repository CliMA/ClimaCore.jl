...
# Define eltype/broadcastable/similar/copy to match DataStyle broadcasting, but
# with the application of a mask when copying
...
Base.Broadcast.broadcastable(bc::Base.Broadcast.Broadcasted{<:AbstractFieldStyle}) =
...
function Base.copy(bc::Base.Broadcast.Broadcasted{<:AbstractFieldStyle})
