...
@inline function column(field::ExtrudedFiniteDifferenceField, colidx::ColumnIndex{1})
    column(field, colidx.ij[1], colidx.h)
end
@inline function column(field::SpectralElementField2D, colidx::ColumnIndex{2})
    column(field, colidx.ij[1], colidx.ij[2], colidx.h)
end
@inline function column(field::ExtrudedFiniteDifferenceField, colidx::ColumnIndex{2})
    column(field, colidx.ij[1], colidx.ij[2], colidx.h)
end
