...
# Selecting the bases with unrolled_flatmap combines the zip, the selection,
# and the projection back onto the bases into a single pass, so no intermediate
# iterator of (basis, index) pairs is constructed.
