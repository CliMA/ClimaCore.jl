...
RectangleMesh(domain::RectangleDomain, n1, n2) = RectangleMesh(
...
function opposing_face(mesh::RectangleMesh, elem::CartesianIndex{2}, face::Int)
    @assert 1 <= face <= 4
    x1, x2 = elem.I
