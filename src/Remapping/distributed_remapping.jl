...
function _Remapper(
    ...
    # Reconstruct BilinearRemapping with the computed arrays, keeping the
    # BilinearRemapping() interface.
    if horiz_method isa BilinearRemapping
...
function interpolate!(
    ...
    while true
        ...
        if !isa_vertical_space
            # For spaces with a horizontal component, reshape the output onto the
            # target grid.
