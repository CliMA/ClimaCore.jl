...
Base.@propagate_inbounds function operator_evaluate(
    ...
    return Geometry.Covariant12Vector(-Dᵀ₁Wf / W, -Dᵀ₂Wf / W)
end
...
Base.@propagate_inbounds function operator_evaluate(
    ...
    if length(work) == 2
        ...
        return Geometry.Contravariant3Vector(D₁v₂ / local_geometry.invJ)
    elseif length(work) == 1
        ...
        return Geometry.Contravariant2Vector(-D₁v₃ / local_geometry.invJ)
    else
        _, v₂, v₃ = work
        D₁v₂ = D[i, 1] * v₂[1, vt]
        D₁v₃ = D[i, 1] * v₃[1, vt]
...
Base.@propagate_inbounds function operator_evaluate(
    ...
    if length(work) == 2
        ...
        return Geometry.Contravariant3Vector(-Dᵀ₁Wv₂ / local_geometry.WJ)
    elseif length(work) == 1
        (Wv₃,) = work
        Dᵀ₁Wv₃ = D[1, i] * Wv₃[1, vt]
        for k in 2:Nq
        ...
        return Geometry.Contravariant2Vector(Dᵀ₁Wv₃ / local_geometry.WJ)
    else
        _, Wv₂, Wv₃ = work
        Dᵀ₁Wv₂ = D[1, i] * Wv₂[1, vt]
        Dᵀ₁Wv₃ = D[1, i] * Wv₃[1, vt]
