            ...
            if v + pd < li || v + pd > ri
                ...
                UnrolledUtilities.unrolled_sum((ld1:ud1...,)) do mat1_row_d
                    if ld2 <= pd - mat1_row_d <= ud2 &&
                       (Int32(0) < v + mat1_row_d + half <= Int32(CUDA.blockDim().x))
                        @inbounds mat1_row[mat1_row_d] *
                                  matrix2[v + mat1_row_d + half+ (i - Int32(1)) * Int32(CUDA.blockDim().x)][pd - mat1_row_d]
                    else
                        zero_entry
                    end
                end
    ...
    @inbounds begin
        ...
        prod_entries = UnrolledUtilities.unrolled_map((pd1:pd2...,)) do pd
            if v + pd < li || v + pd > ri
                ...
                UnrolledUtilities.unrolled_sum((ld1:ud1...,)) do mat1_row_d
                    if ld2 <= pd - mat1_row_d <= ud2 && (Int32(0) < v + mat1_row_d <= Int32(CUDA.blockDim().x - 1))
                        @inbounds mat1_row[mat1_row_d] *
                                  matrix2[v + mat1_row_d+ (i - Int32(1)) * Int32(CUDA.blockDim().x)][pd - mat1_row_d]
                    else
                        zero_entry
                    end
                end
    ...
    @inbounds begin
        ...
        prod_entries = UnrolledUtilities.unrolled_map((pd1:pd2...,)) do pd
            if v + pd < li || v + pd > ri
                ...
                UnrolledUtilities.unrolled_sum((ld1:ud1...,)) do mat1_row_d
                    if ld2 <= pd - mat1_row_d <= ud2 && (Int32(0) < v + mat1_row_d <= Int32(CUDA.blockDim().x))
                        @inbounds mat1_row[mat1_row_d] *
                                  matrix2[v + mat1_row_d+ (i - Int32(1)) * Int32(CUDA.blockDim().x)][pd - mat1_row_d]
                    else
                        zero_entry
...
Base.@propagate_inbounds function row_mul_vec!(
    ...
    @inbounds begin
        ...
        return UnrolledUtilities.unrolled_mapreduce(
            ...
            if (Int32(0) < v + mat1_row_d + half <= Int32(CUDA.blockDim().x))
                @inbounds outer_or_mul(mat1_row[mat1_row_d], matrix2[v + mat1_row_d + half+ (i - Int32(1)) * Int32(CUDA.blockDim().x)])
            else
                zero_entry
            end
        end
...
Base.@propagate_inbounds function row_mul_vec!(
    ...
    @inbounds begin
        ...
        return UnrolledUtilities.unrolled_mapreduce(
            ...
            if (Int32(0) < v + mat1_row_d <= Int32(CUDA.blockDim().x - 1))
                @inbounds outer_or_mul(mat1_row[mat1_row_d], matrix2[v + mat1_row_d+ (i - Int32(1)) * Int32(CUDA.blockDim().x)])
            else
                zero_entry
            end
        end
...
Base.@propagate_inbounds function row_mul_vec!(
    ...
    @inbounds begin
        ...
        return UnrolledUtilities.unrolled_mapreduce(
            ...
            if (Int32(0) < v + mat1_row_d <= Int32(CUDA.blockDim().x))
                @inbounds outer_or_mul(mat1_row[mat1_row_d], matrix2[v + mat1_row_d+ (i - Int32(1)) * Int32(CUDA.blockDim().x)])
            else
                zero_entry
            end
